% Computes the mean squared deviation form the initial value. For instance, 
% a bunch of data runs y_i(t) (where i runs over the independent runs) get 
% transformed to
%    sqDev(t) = (y(t) - y(1)).^2
...
function [sqDev, errs, newTime] = meanSquaredDeviation(data, time)
