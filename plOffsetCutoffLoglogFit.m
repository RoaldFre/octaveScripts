...
function [exponent, x1, xOffset, yOffset, cutOff, cutOffWidth, exponentErr, x1err, xOffsetErr, yOffsetErr, cutOffErr, cutOffWidthErr, f] = plOffsetCutoffLoglogFit(xs, ys, yerr, guessExponent, guessX1, guessCutOff, guessCutOffWidth, guessXoffset, guessYoffset)
...
[f, p, pErr] = leasqrError(
		...
		@(x,p)(real(plOffsetCutoffLoglog(x, p(1), p(2), p(3), p(4), p(5), p(6)))),
		10);
